...
BLOG_AUTHOR = "Fabien Dubosson"  # (translatable)
BLOG_TITLE = "Why doing it the simple way?"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://StreakyCobra.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://StreakyCobra.github.io/"
BLOG_EMAIL = "fabien.dubosson@gmail.com"
BLOG_DESCRIPTION = "StreakyCobra's blog"  # (translatable)
